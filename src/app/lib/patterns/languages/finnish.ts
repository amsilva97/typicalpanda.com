...
export const finnish: LanguageDefinition = {
  ...
  options: {
    name: "Finnish",
    minLength: 4,          // Finnish names can be compact
    maxLength: 16,         // Allow for longer Finnish names like Lemminkäinen
    startMarker: "^",
    endMarker: "$",
    maxLoops: 55,          // Higher for vowel-rich patterns
    singleLetterLimiter: 4, // Very generous - Finnish loves vowel sequences
    clusterLimiter: 2      // Allow double consonants (gemination) and compounds
  }
};