// // This file is deprecated. Generic pattern functions have been moved to ../patterns.ts// This file is deprecated. Generic pattern functions have been moved to ../patterns.ts// This file is deprecated. Generic pattern functions have been moved to ../patterns.ts

// // Keeping only for legacy compatibility

// // Keeping only for legacy compatibility// Keeping only for legacy compatibility

// import { oldEnglish } from '../patterns/oldEnglish';

// import { 

//   analyzeName, 

//   AnalysisResult, import { oldEnglish } from '../patterns/oldEnglish';import { oldEnglish } from '../patterns/oldEnglish';

//   NameSegmentation, 

//   NameSuggestion,import { import { 

//   formatSegmentation,

//   isNameAnalyzable,  analyzeName,   analyzeName, 

//   analyzeNameGeneric

// } from '../patterns';  AnalysisResult,   AnalysisResult, 



// // Re-export for backward compatibility  NameSegmentation,   NameSegmentation, 

// export type { AnalysisResult, NameSegmentation, NameSuggestion };

// export { formatSegmentation, isNameAnalyzable, analyzeNameGeneric };  NameSuggestion,  NameSuggestion,



// /**  formatSegmentation,  formatSegmentation,

//  * Old English specific convenience function (legacy)

//  */  isNameAnalyzable,  isNameAnalyzable,

// export function analyzeOldEnglishName(inputName: string): AnalysisResult {

//   return analyzeName(inputName, oldEnglish);  analyzeNameGeneric  analyzeNameGeneric
...
// export type { AnalysisResult, NameSegmentation, NameSuggestion };export type { AnalysisResult, NameSegmentation, NameSuggestion };

// export { formatSegmentation, isNameAnalyzable, analyzeNameGeneric };export { formatSegmentation, isNameAnalyzable, analyzeNameGeneric };



// /**/**

//  * Old English specific convenience function (legacy) * Old English specific convenience function (legacy)

//  */ */

// export function analyzeOldEnglishName(inputName: string): AnalysisResult {export function analyzeOldEnglishName(inputName: string): AnalysisResult {

//   return analyzeName(inputName, oldEnglish);  return analyzeName(inputName, oldEnglish);
...
//   const recognizedParts = findRecognizedParts(name);
  
//   // Strategy 3: Sound-alike replacements
//   const soundAlikes = generateSoundAlikeSuggestions(name);
  
//   // Generate suggestions from similar starts
//   for (const start of similarStarts.slice(0, 3)) {
//     const compatibleEndings = getCompatibleEndings(start);
...
//         reason: `Similar sound to "${inputName}" with authentic Old English structure`
//       });
//     }
//   }
...
//     const alternatives = generateAlternativesWithPart(part, name);
...
// /**
//  * Find parts of the name that are recognized Old English elements
//  */
// function findRecognizedParts(name: string): string[] {
//   const parts: string[] = [];
//   const allElements = Object.keys(oldEnglish.meanings);
...
//   const lang = language || oldEnglish;
//   const possibleContinuations = lang.patterns[start] || [];
//   const endings: string[] = [];
  
//   for (const continuation of possibleContinuations) {
//     if (continuation === lang.options.endMarker) continue; // Skip direct endings
    
//     const continuationPossibilities = lang.patterns[continuation] || [];
//     if (continuationPossibilities.includes("$")) {
...
//  */
// function generateAlternativesWithPart(part: string, originalName: string): NameSuggestion[] {
//   const alternatives: NameSuggestion[] = [];
//   const startingElements = oldEnglish.patterns[oldEnglish.options.startMarker] || [];
  
//   // Try the part as an ending
//   for (const start of startingElements.slice(0, 3)) {
//     if (start === part) continue;
    
//     const startPossibilities = oldEnglish.patterns[start] || [];
...
//         name: suggestedName,
//         segments: [start, part],
//         meanings: [oldEnglish.meanings[start] || 'unknown', oldEnglish.meanings[part] || 'unknown'],
//         similarity: similarity,
...
//  */
// function generateSoundAlikeSuggestions(name: string): NameSuggestion[] {
//   const suggestions: NameSuggestion[] = [];
//   const startingElements = oldEnglish.patterns[oldEnglish.options.startMarker] || [];
...
//           meanings: [oldEnglish.meanings[start] || 'unknown', oldEnglish.meanings[ending] || 'unknown'],
//           similarity: similarity,
//           reason: `Sound-alike alternative with clearer Old English meaning`
//         });
//       }
//     }
//   }
...
//  */
// function generateVariations(name: string): NameSuggestion[] {
