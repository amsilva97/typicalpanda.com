...
export const oldEnglish: LanguageDefinition = {
  patterns: {
    ...
    "Har": ["d", "old", "ald", "ry", "bert", "mond", "wick"],
    "Hild": ["a", "e", "red", "burg", "gard", "run"],
    "Leo": ["f", "fr", "ric", "wald", "bert", "fwin", "pold"],
    "Os": ["b", "g", "r", "w", "wald", "ric", "mund", "win", "geat", "laf"],
    "Ulf": ["r", "w", "ric", "gar", "red", "stan", "heim", "kell"],
    "Wil": ["f", "fr", "h", "fred", "helm", "ric", "bert", "grim", "laf"],
    "Wulf": ["r", "st", "ric", "gar", "red", "helm", "here", "noth"],
    ...
    "fr": ["ed", "ic", "ith", "ied", "ank", "a", "e", "i", "$"],
    "th": ["red", "ulf", "ild", "ane", "a", "e", "$"],
    "el": ["d", "f", "m", "bert", "mund", "ric", "mer", "a", "e", "$"],
    "er": ["ic", "ed", "ald", "bert", "mund", "gar", "a", "e", "$"],
    "ar": ["d", "ic", "ald", "ell", "ny", "a", "e", "$"],
    "ir": ["ed", "ic", "ald", "a", "e", "$"],
    "ht": ["ric", "red", "$"],
    "ry": ["$"],
    "ny": ["$"],
    ...
    "ald": ["r", "w", "ric", "bert", "mund", "wald", "$"],
    "red": ["ric", "mund", "wald", "bert", "$"],
    "ert": ["ric", "mund", "wald", "$"],
    "orn": ["mund", "wald", "$"],
    "ard": ["ric", "mund", "wald", "$"],
    "ild": ["a", "e", "bert", "mund", "$"],
