    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4">Pattern Analysis & Testing</h2>
          <p className="text-gray-600 mb-4">
            Test the structure, flow, and quality of the Old English pattern definitions.
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                onClick={runPatternStructureTest}
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-4 text-sm text-gray-600">
            <div>
              <strong className="text-blue-600">Pattern Structure Test:</strong>
              <p>Analyzes the pattern definition structure, checks for orphaned patterns, dead-ends, and connection statistics.</p>
            </div>
            <div>
              <strong className="text-green-600">Pattern Flow Test:</strong>
              <p>Tests specific authentic Old English name flows (like ael→red, god→ric) and validates that major elements can reach endings.</p>
            </div>
            <div>
              <strong className="text-purple-600">Generation Path Test:</strong>
              <p>Generates names and analyzes their structural components to verify authentic Old English patterns.</p>
            </div>
            <div>
              <strong className="text-orange-600">Pattern Quality Test:</strong>
              <p>Evaluates generated names for authentic characteristics: proper prefixes/suffixes, pronounceability, and length.</p>
            </div>
